...
*/
	...
	$result .= '<input type="hidden" name="pow_url" value="'.$GLOBALS['URLS']['Site'].'System/Auctions/Payment_success/?type=transferujpl">';
	$result .= '<input type="hidden" name="pow_url_blad" value="'.$GLOBALS['URLS']['Site'].'System/Auctions/Payment_error/?type=transferujpl">';
