...
class BbCodeFilterBasic
{
	...
	public function parseQuote($tag, $openNode, $body, &$closeNode, $settings)
	{
		...
		$openNode['text'].='<div class="quote_title" style="background-color: #11377B; color: #ffffff; font-size: 12px; font-weight: bold; padding: 5px;
">Cytat '.$divText.':</div><div class="quote_area" style="padding: 5px;">';
