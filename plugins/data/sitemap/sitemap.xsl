	...
	<xsl:template match="/">
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				...
				<div id="footer">
					XSLT Template Created by <a href="http://www.arnebrachhold.de/">Arne Brachhold</a>. Modified by <a href="http://www.blixtech.com/">Blixtech.com</a>. This XSLT template is released under GPL
				</div>
			</body>
		</html>
	</xsl:template>
