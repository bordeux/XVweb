...
DebugCons.Load = function(){
	...
	$("<span></span>").addClass("debugm").css({height:"20px", background:"", padding:"5px;", float:"right", paddingRight:"5px"}).append($("<img src='"+rootDir+"plugins/data/debug/debug.png' alt='Debug'/> ").click(function(){
	
	$("#ConsoleWindow").html(["<img src='",rootDir,"plugins/data/debug/xvdebug.png' alt='Debug'/><br/> Version: ",DebugCons.about.version,"<br/> Author: ", DebugCons.about.author].join('')).toggle("slow");
	})).append(' <span>|</span> ').append(
	$("<span></span>").addClass("debugm").attr("id", "ConsoleTime").html("<img src='"+rootDir+"plugins/data/debug/time.png' />"+(Math.round(DebugConsole.GeneratedTime*10000)/10000)).click(function(){
	...
	$("<span></span>").addClass("debugm").attr("id", "ConsoleSQl").html("<img src='"+rootDir+"plugins/data/debug/database.png' /> "+DebugConsole.SQL.length).click(function(){
		$("#ConsoleWindow").html("");
