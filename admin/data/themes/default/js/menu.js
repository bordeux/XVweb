...
//	p_string = p_string.replace(/'/g, '&#039;');
	...
	var DrawMenu = function(){
		...
		$(XMLMenu).children().each(function(){
			WorkVar = '<fieldset style="padding-bottom:40px;">';
			WorkVar += ('<legend><span class="xv-easyedit xv-menu-main-name">'+$(this)[0].tagName+'</span></legend>');
			$(this).children().each(function(){
				WorkVar +='<div class="ui-dialog ui-widget ui-widget-content ui-corner-all  xv-menu-wd xv-menu-submenu"  style="width:100%;">';
				...
				WorkVar +=	 '</table>';	
				$(this).children().each(function(){
					WorkVar +='<div class="ui-dialog ui-widget ui-widget-content ui-corner-all  xv-menu-wd xv-menu-url"  style="width:100%;" >';
...
$("#MenuVisualForm input[type='submit']").click(function(){
	$("#MenuVisualForm #MenuXML").val(GetXML());
	$("#MenuVisualForm").submit();
});
});
