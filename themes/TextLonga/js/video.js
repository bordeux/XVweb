...
var YTClass = "";
	...
	$(this).parent().after(
		$('<div id="YouTube-'+YTID+'" class="Video YouTube"></div>').attr({ link: $(this).parent().attr("href"), player : $(this).parent().attr("class")}).html('<iframe width="480" height="385" src="http://www.youtube.com/embed/'+YTID+'" frameborder="0" allowfullscreen></iframe>')).remove();
	});
