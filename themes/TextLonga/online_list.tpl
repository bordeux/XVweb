...
{foreach from=$OnlineList item=OnlineArray}
 <tr class="TableCell">
  ...
  <td><a href="{$UrlScript}Users/{$OnlineArray.UserLoged|urlrepair}">
	  {$OnlineArray.UserLoged}
	  </a>
   </td>
	  
  <td><a href="{$URLS.Site}{$OnlineArray.UrlLocation|replace:' ':'_'|urlrepair|substr:1}" >{$OnlineArray.UrlLocation|rawurldecode|escape:"html"}</a></td>
