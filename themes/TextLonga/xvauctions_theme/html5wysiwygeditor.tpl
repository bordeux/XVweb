<div class="xvauction-editor">
{if $xvauctions_wysiwyg_AddShowTemplates}
                ...
                <div class="h5w-main">
                        ...
                        <div class="h5w-tabs">
                                ...
                                <div class="h5w-tabs-bottom" >
                                        ...
                                        <textarea id="h5w-textarea-id" class="h5w-texarea"  name="{$xvauctions_wysiwyg_name}" >{$xvauctions_wysiwyg_text|escape:"html"}</textarea>
