...
{/if}
	...
	<div class="category_parents_tree" >
		<a href="{$URLS.Auctions}/">{"xca_auctions"|xvLang}</a> 
			...
			&gt;&gt; <a href="{$URLS.AuctionPanel}/comments_to_add/">{"xca_comments_to_add"|xvLang}</a> 
	...
	<div class="xauction-tabs ui-tabs ui-widget ui-widget-content ui-corner-top">
		<div class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-top">
			<div style="text-align:center; color: #474747; font-size: 14px;">{"xca_comments_to_add"|xvLang}</div>
		</div>
		<div>
			...
			<table style="width : 100%; text-align: center;">
				...
				<thead> 
					<tr>
						...
						<th class="items-id"><a href='?{addget value="sortby=id&sort=$SmartySort"}'>{$SmartyChar} {"ID"|xvLang}</a></th>
						...
						<th class="items-contractor"><a href='?{addget value="sortby=contractor&sort=$SmartySort"}'>{$SmartyChar} {"xca_contractor"|xvLang}</a></th>
