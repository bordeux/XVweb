...
<div class="ui-li ui-li-divider ui-btn ui-bar-b ">
	<a href='{$UrlScript}Users/{$Comment.Author}' data-role="button" data-inline="true" style="margin:0;">{$Comment.Author}</a> {$language.Day} {$Comment.Date|replace:'-':'.'} {if $Comment.ModificationDate}, {$language.Modification} {$Comment.ModificationDate|replace:'-':'.'} {/if}
