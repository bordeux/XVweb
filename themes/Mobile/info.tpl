<div id="InoContent">
<hr />
		<a href="?{add_get_var value="doc=true"}"><img src="{$UrlTheme}img/docicon.png" alt="Microsoft Word" /></a>
		<a href="?{add_get_var value="view=true&download=true&html=true"}"><img src="{$UrlTheme}img/htmlicon.png"  alt="HTML" /></a>
		<a href="?{add_get_var value="pdf=true"}"><img src="{$UrlTheme}img/pdficon.png" alt="PDF" /></a>
